...
function ProductPage({
  ...
  if (product && products) {
    similar_products = products.filter(
      (item) =>
        (item.id != product.id && item.sub_category == product.sub_category) ||
  ...
  return (
    <div className=' '>
        ...
        <div className=' grid h-[200px]'>
          <div className='grid mini-thumb '>
            <div
              className={
                thumbnail
                  ? "h-[60px] w-[50px] bg-neutral-200 grid grid-rows-[70%_30%] gap-[5px] px-[5px] py-[5px] border-[1px] border-black"
                  : "h-[60px] w-[50px] bg-neutral-200 grid grid-rows-[70%_30%] gap-[5px] px-[5px] py-[5px]"
              }
          ...
          <div
            className={
              thumbnail
                ? "grid mini-scroll w-[50px]"
                : "grid mini-scroll w-[50px] border-[1px] border-black"
            }
        ...
        <div className='product-display grid grid-cols-[700px_700px]'>
          {thumbnail ? (
            <div className='display-thumbnail-carousel select-none grid grid-flow-row overflow-x-hidden gap-[20px]'>
              <div
                className='main-image h-[700px] min-w-[700px] grid grid-flow-col ease-in'
          ...
          <div
            className={
              thumbnail
                ? " display-product-info   mx-20"
                : " display-product-info  ml-[-10px] mr-[184px]"
            }
          >
            {product ? (
              <div className='grid gap-[20px] sticky top-[76px]'>
                <div className=' grid  '>
                  <h1 className='  mt-[-14px] font-extrabold text-[40px] place-self-start opacity-[70%]'>
                    {product.name}
                  </h1>
                </div>
                ...
                <div>
                  <h1 className=' font-semibold text-3xl opacity-[60%]'>
      ...
      {add ? (
        <CartModal setadd={setadd} count={counter} product={product} />
      ) : null}
    </div>
  );
}
