...
export default function LookBook({setcardinfo, handleis, is}) {
    ...
    const bathEndpoints = ['http://127.0.0.1:5555/product/1','http://127.0.0.1:5555/product/2','http://127.0.0.1:5555/product/3','http://127.0.0.1:5555/product/4','http://127.0.0.1:5555/product/6','http://127.0.0.1:5555/product/7'];
    const decorEndpoints = ['http://127.0.0.1:5555/product/23','http://127.0.0.1:5555/product/20','http://127.0.0.1:5555/product/17','http://127.0.0.1:5555/product/49'];
    ...
    function handlecurrent(current, div){
        if(div == 'image'){
            ...
            if(current == 'Bathroom Accessories'){
                ...
                return <div className=' grid grid-rows-[100px_300px_100px]'>
                    ...
                    <div>
                        ...
                        <div className='besto ml-[20px]  flex gap-[18px] grid-flow-col  '
                            style={{transform: `translate(-${currentslidebath * 17.2}%)`}}
                        >
                            {bath ? bath.map((item) => {
                                ...
                                >
                                    ...
                                    <div className=''>
                                        ...
                                        <img src={'http://127.0.0.1:5555' + item.images[1]} alt=""  className={showcase && index == bath.indexOf(item) ? 'h-[200px] min-w-[200px] border-[1px] border-black' : 'h-[200px] min-w-[200px]'}/>
    ...
    <div>
        ...
        <div className=' grid grid-flow-row grid-rows-[50px_100px_501px]'>
            <div className='  grid grid-cols-1'>
                <h1 className='font-semibold font-serif grid place-self-center text-3xl italic'>Shop These Designer - Curated Collections</h1>
            ...
            <div className='  grid grid-cols-[250px_1340px_250px]'>
                ...
                <div className=' grid grid-cols-2 gap-2'>
                    <div className=' '>
                        ...
                        {handlecurrent(current, 'image')}


                    </div>

                    <div>
                        {handlecurrent(current, 'carrousel')}
