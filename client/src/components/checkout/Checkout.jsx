...
export default function Checkout({cart}) {
  ...
  return (
    <div className='grid '>
        ...
        <div className=' grid place-self-center grid-cols-[70%_30%] w-[78%] my-[20vh] '>
            ...
            <div className=' grid px-5'>
                <div className='flex flex-col'>
                    ...
                    <div className='grid grid-flow-row'>
                        ...
                        {cart ?
                        cart.map((item) => {
                            return <div className='grid grid-flow-col h-[8vh] border-b-[1px] border-[#a5a2a2]'>
                                <h1 className='  grid center-start pr-24'>{item.name} X{item.quantity[1]}</h1>
                                <h1 className='grid center-end'>KSH{item.price * item.quantity[1]}</h1>
                    ...
                    <div className='flex flex-col mt-10'>
                        ...
                        <div>
                            <div className=' flex gap-3'>
                                ...
                                <div class="checkbox-wrapper-12">
                                    <div class="cbx">
                                        <input id="cbx-12" type="checkbox" checked={Mpesa} onChange={(e) => {
                                            setcard(Mpesa)
                                ...
                                <label htmlFor="checkbox-wrapper-12">MPESA PAYEMENT</label>
                        ...
                        <div>
                            <div className=' flex gap-3'>
                                ...
                                <div class="checkbox-wrapper-12">
                                    <div class="cbx">
                                        <input id="cbx-12" type="checkbox" checked={card} onChange={(e) => {
                                            setmpesa(card)
                                            setcard(!card)
                                ...
                                <label htmlFor="checkbox-wrapper-12">CARD PAYEMENT</label>
