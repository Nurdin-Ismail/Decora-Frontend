    ...
    <div>
      ...
      <section className='  flex h-[390px] mt-20 mb-32 ml-[200px]  '>
        <div className=' bg-white h-[200px]  min-w-[20%] max-w-[20%]'>
          ...
          <p className='mt-2'>
            Transform your living space with our handpicked collection of
            top-selling home decor essentials.
          </p>
      ...
      <section className='new  h-[430px] mt-[100px] mb-48 ml-[200px]'>
        <div className='flex justify-between mr-[70px] '>
          <div className=' font-[19px] text-3xl '>New Arrivals</div>

          <div className='flex'>
            <img
              className=' cursor-pointer rotate-180 h-[30px]'
              src={forward}
              alt=''
              onClick={() => handlearrows2("left")}
            />
            <img
              className=' cursor-pointer h-[30px]'
              src={forward}
              alt=''
              onClick={() => handlearrows2("right")}
            />
          </div>
        </div>
